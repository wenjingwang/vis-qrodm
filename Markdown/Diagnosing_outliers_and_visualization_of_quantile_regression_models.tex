...
{\centering \includegraphics{Diagnosing_outliers_and_visualization_of_quantile_regression_models_files/figure-latex/unnamed-chunk-3-1} 
...
\hat{\theta}\emph{\{{[}i{]}\}=\hat{\theta}+\{-\ddot{Q}(\hat{\theta}\textbar{}\hat{\theta})\}\^{}\{-1\}\dot{Q}}\{{[}i{]}\}(\hat{\theta}\textbar{}\hat{\theta})
